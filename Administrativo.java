...
public  class Administrativo extends Personal {
    ...
    protected double Vales_despensa;
    ...
    //Metodos
      ...
      public void muestraDatos(){
        ...
        System.out.println("Tu fecha de Nacimiento es(sin diagonal) ");
         Fecha_Nacimiento = teclado.nextInt();
         
         System.out.println("Tu fecha de ingreso es:  ");
         Fecha_ingreso = teclado.nextInt();
        
          System.out.println("Tu sueldo base es: ");
        Sueldo_base = teclado.nextDouble();
          
          System.out.println("Tu Vale es de: ");
       Vales_despensa = teclado.nextDouble();
          ...
          System.out.println("su Beca es de "+Vales_despensa);
    ...
    @Override
     public void calcularImpuestos(){
       ...
       double montocalcular = Sueldo_base+Vales_despensa;
      double porcentaje = montocalcular*12/100;
